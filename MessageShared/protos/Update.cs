...
namespace MessageShared {
    ...
    static Update() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "c3QSDAoEdHlwZRgBIAIoBRISCgpuYW1lT2JqZWN0GAIgAigJEhAKCGpzb25J", 
  ...
  public sealed partial class mUpdateRequest : pb::GeneratedMessage<mUpdateRequest, mUpdateRequest.Builder> {
    ...
    private static readonly string[] _mUpdateRequestFieldNames = new string[] { "jsonItem", "nameObject", "type" };
    private static readonly uint[] _mUpdateRequestFieldTags = new uint[] { 26, 18, 8 };
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      ...
      if (hasNameObject) {
        output.WriteString(2, field_names[1], NameObject);
      }
      if (hasJsonItem) {
        output.WriteString(3, field_names[0], JsonItem);
      }
